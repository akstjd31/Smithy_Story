...
namespace Smithy_Story
{
    public class RequestData
    {
        ...
        {
            // 재료 배달 의뢰
            manager.AddItem(new Request(101,     "돌 10개를 납품해주세요!",        1, RequestType.DeliverItem, neededCount: 10));
            manager.AddItem(new Request(102,     "나무 8개를 가져다주세요!",       1, RequestType.DeliverItem, neededCount: 8));
                manager.AddItem(new Request(103, "철 5개를 납품해주세요!",         1, RequestType.DeliverItem, neededCount: 5));
                manager.AddItem(new Request(104, "가죽 4개가 필요합니다!",         1, RequestType.DeliverItem, neededCount: 4));
                manager.AddItem(new Request(105, "금광석 3개를 가져다주세요!",     3, RequestType.DeliverItem, neededCount: 3));
                manager.AddItem(new Request(106, "다이아몬드 1개를 납품해주세요!", 5, RequestType.DeliverItem, neededCount: 1));
                manager.AddItem(new Request(107, "루비 2개를 구해오세요!",         3, RequestType.DeliverItem, neededCount: 2));
                manager.AddItem(new Request(108, "은광석 5개를 납품해주세요!",     2, RequestType.DeliverItem, neededCount: 5));
                manager.AddItem(new Request(109, "청동석 3개를 납품해주세요!",     2, RequestType.DeliverItem, neededCount: 3));
                manager.AddItem(new Request(110, "나무 30개 대량 납품 요청!",      4, RequestType.DeliverItem, neededCount: 30));
            ...
            manager.AddItem(new Request(303, "철제도끼를 +3까지 강화해주세요!",  2, RequestType.EnhanceWeapon, item: WeaponData.GetByName("철제도끼")));
            manager.AddItem(new Request(304, "곡괭이를 +7로 강화해보고 싶어요.", 5, RequestType.EnhanceWeapon, item: WeaponData.GetByName("곡괭이")));
            manager.AddItem(new Request(305, "용린검을 +5로 강화해주세요!",      7, RequestType.EnhanceWeapon, item: WeaponData.GetByName("용린검")));
